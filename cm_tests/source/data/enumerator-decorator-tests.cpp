...
namespace data {
    ...
    EnumeratorDecoratorTests::EnumeratorDecoratorTests()
        : TestSuite("EnumeratorDecoratorTest")
    {
    }
    ...
    {
        Entity parentEntity;
        EnumeratorDecorator decorator(&parentEntity, "Test Key", "Test Label", static_cast<int>(eTestEnum::Value1), descriptionMapper);
        ...
        QCOMPARE(decorator.value(), static_cast<int>(eTestEnum::Value1));
        QCOMPARE(decorator.valueDescription(), QString("Value 1"));
    }
    ...
    void EnumeratorDecoratorTests::setValue_givenSameValue_takesNoAction()
    {
        ...
        decorator.setValue(static_cast<int>(eTestEnum::Value1));
    ...
    {
        EnumeratorDecorator decorator;
        decorator.setValue(static_cast<int>(eTestEnum::Value3));

        QCOMPARE(decorator.jsonValue(), QJsonValue(static_cast<int>(eTestEnum::Value3)));
    }
