...
namespace models {
    ...
    void ClientTests::verifyAppointments(const QJsonObject& jsonObject)
    {
        ...
        QCOMPARE(appointment1.value("startAt").toString(), QString("2017-08-20T12:45:00.000"));
        QVERIFY(appointment1.contains("endAt"));
        QCOMPARE(appointment1.value("endAt").toString(), QString("2017-08-20T13:00:00.000"));
        ...
        QCOMPARE(appointment2.value("startAt").toString(), QString("2017-08-21T10:30:00.000"));
        QVERIFY(appointment2.contains("endAt"));
        QCOMPARE(appointment2.value("endAt").toString(), QString("2017-08-21T11:30:00.000"));
