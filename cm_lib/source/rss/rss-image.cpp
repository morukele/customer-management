...
namespace rss {
    ...
    {
    public:
        QString url; // Mandatory. URL of Image that represents the channel.
        QString title; // Mandatory. Describes the image.
        QString link; // Mandatory. URL of the site.
        quint16 width; // Optional. width in pixels, defaults to 144
        quint16 height; // Optional. height in pixels, defaults to 400
